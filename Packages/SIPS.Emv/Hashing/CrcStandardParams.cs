...
public static class CrcStandardParams
{
    public static readonly Dictionary<CrcAlgorithms, Parameters> StandardParameters = new()
        {
            //CRC-8
            ...
            //CRC-31
            {CrcAlgorithms.Crc31PhilSIPS   , new Parameters("CRC-31/PHILSIPS", 31, 0x4C11DB7, 0x7FFFFFFF, false, false, 0x7FFFFFFF, 0xCE9E46C)},
