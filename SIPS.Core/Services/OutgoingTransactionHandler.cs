    ...
    ) : IOutgoingTransactionHandler
{
    ...
    public async Task<Response<PaymentResponseDto>> HandleAsync(PaymentRequestDto message, CancellationToken ct)
    {
        ...
        try
        {
            var request = BuildRequest(message, fromBIC, ourAgentBic, txId);
            var signed = _signer.SignEnvelope(request);
            var entity = CreateISOMessage(message, fromBIC, ourAgentBic, txId, signed);
    ...
    private static string BuildRequest(PaymentRequestDto message, string fromBIC, string agentBIC, string txId)
    {
    ...
    private static PostgreSQL.Models.ISOMessage CreateISOMessage(PaymentRequestDto message, string fromBIC, string agentBIC, string txId, string signedMessage)
    {
