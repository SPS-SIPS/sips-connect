...
public abstract class Enumeration<TId> : IComparable where TId : IEquatable<TId>
{
    protected Enumeration()
    {
        ...
        RationOrBalance = null;
    }

    protected Enumeration(TId id, string name, string groupId, decimal? ratioOrBalance = null)
        => (Id, Name, GroupId, RationOrBalance) = (id, name, groupId, ratioOrBalance);

    public string Name { get; private set; }
    public string GroupId { get; private set; }
    public decimal? RationOrBalance { get; private set; }
    public TId Id { get; private set; }

    public override string ToString() => Name;

    public Lookup<TId> ToLookup => new(Id, Name, GroupId, RationOrBalance);
    ...
    public static T FromGroupId<T>(string groupId) where T : Enumeration<TId>, new()
    {
        var matchingItem = parse<T, string>(groupId, "groupId", item => item.GroupId == groupId);
        return matchingItem;
    }
