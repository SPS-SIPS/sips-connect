...
public sealed class SupportedMessageTypes : Enumeration<string>
{
    ...
    public static SupportedMessageTypes CreditTransferReturnRequest = new("pacs.004.001.11", "Credit Transfer Return Request", "urn:iso:std:iso:20022:tech:xsd:pacs.004.001.11");
